...
<div class="l-wrapper">
    ...
    <button type="submit" class="btn btn--icon btn--red" role="button"><span class="icon icon--left fa fa-trash-o" aria-hidden="true"></span>@lang('cms::block.featured.controls.delete')</button>
    {!! CMSForm::close() !!}
    <hr class="hr" />
</div>
